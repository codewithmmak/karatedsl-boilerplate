Feature: GET API header feature
  ...
  Scenario: pass the user user request with headers_Part1
  ...
  Scenario: pass the user user request with headers_Part2
  ...
  Scenario: pass the user user request with headers_Part3
